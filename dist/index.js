(function (global, factory) {
   ...
   * @return undefined 
   */
  function throttleAtonce(fn, time) {
    let previous = 0;
    return function () {
      let now = Date.now();
   ...
   * @return undefined 
   */
  function throttleLatter(fn, time) {
    let timeout = '';
    return function () {
      if (!timeout) {
  ...
  exports.copyToBoard = copyToBoard;
  exports.debonce = debonce;
  exports.format = format;
  exports.pictureGray = pictureGray;
  exports.throttleAtonce = throttleAtonce;
  exports.throttleLatter = throttleLatter;
  exports.type = type;
